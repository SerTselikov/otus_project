...
// Загружает сообщения из RMQ в базу
//
// Параметры:
//  ОбъектКонвертер	 - ОбщийМодуль - менеджер конвертера, имеющий методы для преобразования текста сообщения в объект
//
...
// Сохраняет текстовое сообщение в очередь к отправке (исходящие сообщения)
//
// Параметры:
//  ТекстСообщения			 - Строка - 
//  ДополнительныеПараметры	 - Структура - 
//
Процедура ДобавитьИсходящееСообщение(ТекстСообщения, ДополнительныеПараметры) Экспорт
...
// Выполняет непосредственную отправку текстового сообщения
//
// Параметры:
//  ТекстСообщения			 - Строка - 
//  ДополнительныеПараметры	 - Структура - 
...
Процедура ОтправкаИсходящихСообщенийВRabbitMQОбработчикЗадания() Экспорт
...
Процедура ОтправитьИсходящиеСообщения() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		ОтправитьИсходящееСообщение(Выборка);	
	КонецЦикла;
	
КонецПроцедуры

Процедура ОтправитьИсходящееСообщение(Сообщение) 
