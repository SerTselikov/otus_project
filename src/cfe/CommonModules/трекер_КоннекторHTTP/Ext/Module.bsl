...
//
// Copyright 2017-2024 Vladimir Bondarevskiy
//
...
Процедура ПодготовитьЗапросДляРедиректа(Сессия, ПодготовленныйЗапрос, ПеренаправленныйОтвет)
	...
	Если ПеренаправленныйОтвет.КодСостояния <> КодыСостоянияHTTP.ВременноеПеренаправление_307
		И ПеренаправленныйОтвет.КодСостояния <> КодыСостоянияHTTP.ПостоянноеПеренаправление_308
		// +++ AK o.kriuchkov 2024.12.02 PLATFORMONEC-246 
		И ПеренаправленныйОтвет.КодСостояния <> КодыСостоянияHTTP.ПеремещеноНавсегда_301 Тогда
		//--- AK o.kriuchkov 2024.12.02 PLATFORMONEC-246
